...
(defhydra hydra-new-menu
  ...
  (concat
   "^^^^^^^^New project wizard:\n";;
   "^^^^^^^^------------------------------------------------------------------------------\n";;
   "^*^               ^JVM^           ^Nodejs^            ^dotnet           ^Other^\n";;
   "^^^^^^^^------------------------------------------------------------------------------\n";;
   "_c_:C _C_:C++       _M-j_:Java      _1_:Nodejs          ^C#^                _9_:Ruby\n";;
   "_0_:CL(Roswell)   _M-c_:Clojure   _C-c_:Cljs          Clojure-clr       _e_:Erlang\n";;
   "_g_:Golang        _M-k_:Kotlin    ^C-t:TypeScript^                      _E_:Elixir\n";;
   "_r_:Rust          _M-s_:Scala     ^^                                    _h_:Haskell\n";;
   "_n_:Nim           _M-g_:Groovy    ^^                                    ^^\n";;
   "_o_:OCaml         ^^              ^ReasonML^          ^C-f:F#^          ^^\n";;
   "_p_:Python        ^M-p:Jython^    ^^                  ^C-p:IronPython^  ^^\n";;
   "_2_:Pony          ^^              ^^                  ^^                  ^^\n";;
   "^^^^^^^^------------------------------------------------------------------------------\n";;
...
(defhydra hydra-super-menu
  ...
  (concat ;;
   ...
   "^^^^^^^^^^^^^^^^-------------------------------------------------------------------------------------------------------------------\n"
   "_n_:New        _r_:rname         _>_:gochar-forward   _M-t_:toolbar   _[_:up             _M-c_:capture    _M-1_:%s(ome-auto-menu 1)\n";;
   "_o_:Open       _R_:remove        _<_:gochar-backward  _M-m_:menubar   _/_:down           _M-l_:store-link _M-2_:%s(ome-auto-menu 2)\n";;
   "_b_:Bookmarks  _k_:kill          _g_:grep-dir         _M-s_:speedbar  _;_:left           _M-a_:agenda     _M-3_:%s(ome-auto-menu 3)\n";;
   "_e_(E):Email   _M-k_:kill-other  _G_:grep-proj        _M-d_:sidebar   _'_:right          _M-b_:switchb    _M-4_:%s(ome-auto-menu 4)\n";;
   "_f_:Feed       _C-k_:kill-all    _t_:dict-bing        _=_:scale+      ^0-9:select^       _M-u_:update     _M-5_:%s(ome-auto-menu 5)\n";;
   "_m_:Module     ^^                _T_:dict-bing-web    _-_:scale-      _d_:*Dashboard*    _M-g_:GTD        _M-6_:%s(ome-auto-menu 6)\n";;
   "_i_:IRC        ^^                ^^                   _M_:Message     _C-7_:gitignore    _M-p_:push-blog  _M-7_:%s(ome-auto-menu 7)\n";;
   "_s_(S):Shell   ^^                ^^                   _._:*scratch*   _C-8_:Makefile     _M-e_:en         _M-8_:%s(ome-auto-menu 8)\n";;
   "_u_:URLs       ^^                ^^                   ^^              _C-9_:CMakeList.txt^^               _M-9_:%s(ome-auto-menu 9)\n";;
   "^^             ^^                ^^                   _M-._:load-menu _C-0_:README.org   ^^               _M-0_:%s(ome-auto-menu 0)\n";;
   "^^^^^^^^^^^^^^^^-------------------------------------------------------------------------------------------------------------------\n"
