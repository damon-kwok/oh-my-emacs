...
(defun automenu--c-mode-menu () 
  '("gen-cmake" "cmake-build" "run" "open:CMakeLists.txt"))
...
(defun automenu--c-mode-func (index) 
  (cond ((= 0 index) 
        ...
        ((= 1 index) 
         (ome-cmake-build)) 
        ((= 2 index) 
         (ome-run-command (concat (ome-project-root) "build/main"))) 
        ((= 3 index) 
...
(defun automenu--c++-mode-menu () 
  (automenu--c-mode-menu))
(defun automenu--c++-mode-func (index) 
  (automenu--c-mode-func index))

(defun automenu--objc-mode-menu () 
  (automenu--c-mode-menu))
(defun automenu--objc-mode-func (index) 
  (automenu--c-mode-func index))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(provide 'mod-cc)
;; mod-cc.el ends here
