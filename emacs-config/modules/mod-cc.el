...
;;   (setq dir (m-buf-dirpath)) 
;;   (setq dir1 (concat (m-parent-dirpath dir) "include")) 
;;   (setq dir2 (concat (m-parent-dirpath dir) "src")) 
;;   (setq dir3 (concat (m-parent-dirpath dir) "Classes")) 
;;   (setq dir4 (concat (m-parent-dirpath dir) "Public")) 
;;   (setq dir5 (concat (m-parent-dirpath dir) "Private")) 
